...
set_property PACKAGE_PIN R15 [get_ports {button[1]}]
set_property PACKAGE_PIN R11 [get_ports {button[2]}]
set_property PACKAGE_PIN R17 [get_ports {pitch[0]}]
set_property PACKAGE_PIN U4  [get_ports {pitch[1]}]
...
set_property PACKAGE_PIN U2  [get_ports {user[0]}]
set_property PACKAGE_PIN U3  [get_ports {user[1]}]
